...
const Singleblogpost = () => {
    return (
        <section className="review" id="review">
            ...
            <button className="button" style={{ backgroundColor:'#23329B'}}>Technology</button></div><br></br><br></br>
                <h1 className='rubik-bold-heading '>The Impact of Technology on the Workplace:<br></br> How Technology is Changing</h1><br></br>
                <p>August 20, 2022</p><br></br>
                <img src={contentImage} alt="Content" className="content-image"  /><br></br><br></br>
...
<img src={contentImage1} alt="Content" className="content-image"  /><br></br><br></br>
